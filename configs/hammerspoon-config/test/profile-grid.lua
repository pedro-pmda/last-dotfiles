-- Perfil de prueba del esquema de rejilla.
--
-- Es el mac-personal.lua de antes de migrarlo a lados, congelado aquí: init.lua sigue
-- entendiendo los dos esquemas y este es el único sitio donde queda ejercitado el antiguo.
-- No lo usa ninguna máquina; si algún día se borra el soporte de rejilla, se borra esto.
return {
    appLaunchDelay = 5,
    debugMode = false,
